...
//Copyright tags
if((isset($GLOBALS['sTranslation'])) && ($GLOBALS['sTranslation'] == 'Raya')) {
	define('sCOPYRIGHT_en', '(Raya)');
} else {
...
{
	define('sTEXT_NO_TRANS', '***NB This pericope not yet available in this translation: ');
	if($GLOBALS['sLang'] == 'en')
	{
		$align = 'left';
	} elseif($GLOBALS['sLang'] == 'ar') {
		$align = 'right';
	}
	...
	if($GLOBALS['sLang'] == 'en')
	{
		echo("<td lang='en' dir='ltr'>");
	} elseif($GLOBALS['sLang'] == 'ar') {
		echo("<td lang='ar' dir='rtl'>");
	}
	if($sH1Text != NULL)
		echo("<h1>" . $sH1Text . "</h1>\n");
	if($sH2Text != NULL)
...
function pPrintOutHTMLTextsOnly($sText)
{
	...
	if($GLOBALS['sLang'] == 'en')
	{
		echo("<td lang='en' dir='ltr'><p>" . $sTempText . "</p></td>\n");
	}
	elseif($GLOBALS['sLang'] == 'ar')
	{
		echo("<td lang='ar' dir='rtl'><p>" . $sTempText . "</p></td>\n");
	}
